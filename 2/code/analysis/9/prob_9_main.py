...
array_run_1_angle_pi4, array_run_1_angle_pi2, array_run_1_angle_3pi4 = \
    gid.get_input_data("../../data/run_20_1/postProcessing/singleGraph/9.6/cylnormal_pi4_U.xy",
                       "../../data/run_20_1/postProcessing/singleGraph/9.6/cylnormal_pi2_U.xy", "../../data/run_20_1/postProcessing/singleGraph/9.6/cylnormal_3pi4_U.xy")
...
array_run_2_angle_pi4, array_run_2_angle_pi2, array_run_2_angle_3pi4 = \
    gid.get_input_data("../../data/run_20_2/postProcessing/singleGraph/9.6/cylnormal_pi4_U.xy",
                       "../../data/run_20_2/postProcessing/singleGraph/9.6/cylnormal_pi2_U.xy", "../../data/run_20_2/postProcessing/singleGraph/9.6/cylnormal_3pi4_U.xy")
...
array_run_3_angle_pi4, array_run_3_angle_pi2, array_run_3_angle_3pi4 = \
    gid.get_input_data("../../data/run_20_3/postProcessing/singleGraph/9.6/cylnormal_pi4_U.xy",
                       "../../data/run_20_3/postProcessing/singleGraph/9.6/cylnormal_pi2_U.xy", "../../data/run_20_3/postProcessing/singleGraph/9.6/cylnormal_3pi4_U.xy")
...
array_run_4_angle_pi4, array_run_4_angle_pi2, array_run_4_angle_3pi4 = \
    gid.get_input_data("../../data/run_20_4/postProcessing/singleGraph/9.6/cylnormal_pi4_U.xy",
                       "../../data/run_20_4/postProcessing/singleGraph/9.6/cylnormal_pi2_U.xy", "../../data/run_20_4/postProcessing/singleGraph/9.6/cylnormal_3pi4_U.xy")
...
# Angles for velocity measurement (CCW from positive horizontal axis)
theta_vec = [np.pi/4, np.pi/2, 3*np.pi/4]


# Evaluate and return radial velocity components for simulation 1

u_r_run_1_angle_pi4, s_run_1_angle_pi4 = grv.get_radial_vel(
    array_run_1_angle_pi4, theta_vec[0])
u_r_run_1_angle_pi2, s_run_1_angle_pi2 = grv.get_radial_vel(
    array_run_1_angle_pi2, theta_vec[1])
u_r_run_1_angle_3pi4, s_run_1_angle_3pi4 = grv.get_radial_vel(
    array_run_1_angle_3pi4, theta_vec[2])

# Evaluate and return radial velocity components for simulation 2

u_r_run_2_angle_pi4, s_run_2_angle_pi4 = grv.get_radial_vel(
    array_run_2_angle_pi4, theta_vec[0])
u_r_run_2_angle_pi2, s_run_2_angle_pi2 = grv.get_radial_vel(
    array_run_2_angle_pi2, theta_vec[1])
u_r_run_2_angle_3pi4, s_run_2_angle_3pi4 = grv.get_radial_vel(
    array_run_2_angle_3pi4, theta_vec[2])

# Evaluate and return radial velocity components for simulation 3

u_r_run_3_angle_pi4, s_run_3_angle_pi4 = grv.get_radial_vel(
    array_run_3_angle_pi4, theta_vec[0])
u_r_run_3_angle_pi2, s_run_3_angle_pi2 = grv.get_radial_vel(
    array_run_3_angle_pi2, theta_vec[1])
u_r_run_3_angle_3pi4, s_run_3_angle_3pi4 = grv.get_radial_vel(
    array_run_3_angle_3pi4, theta_vec[2])

# Evaluate and return radial velocity components for simulation 4

u_r_run_4_angle_pi4, s_run_4_angle_pi4 = grv.get_radial_vel(
    array_run_4_angle_pi4, theta_vec[0])
u_r_run_4_angle_pi2, s_run_4_angle_pi2 = grv.get_radial_vel(
    array_run_4_angle_pi2, theta_vec[1])
u_r_run_4_angle_3pi4, s_run_4_angle_3pi4 = grv.get_radial_vel(
    array_run_4_angle_3pi4, theta_vec[2])


# Evaluate and return tangential velocity components for simulation 1

u_theta_run_1_angle_pi4 = gtv.get_tangential_vel(
    array_run_1_angle_pi4, theta_vec[0])
u_theta_run_1_angle_pi2 = gtv.get_tangential_vel(
    array_run_1_angle_pi2, theta_vec[1])
u_theta_run_1_angle_3pi4 = gtv.get_tangential_vel(
    array_run_1_angle_3pi4, theta_vec[2])

# Evaluate and return tangential velocity components for simulation 2

u_theta_run_2_angle_pi4 = gtv.get_tangential_vel(
    array_run_2_angle_pi4, theta_vec[0])
u_theta_run_2_angle_pi2 = gtv.get_tangential_vel(
    array_run_2_angle_pi2, theta_vec[1])
u_theta_run_2_angle_3pi4 = gtv.get_tangential_vel(
    array_run_2_angle_3pi4, theta_vec[2])

# Evaluate and return tangential velocity components for simulation 3

u_theta_run_3_angle_pi4 = gtv.get_tangential_vel(
    array_run_3_angle_pi4, theta_vec[0])
u_theta_run_3_angle_pi2 = gtv.get_tangential_vel(
    array_run_3_angle_pi2, theta_vec[1])
u_theta_run_3_angle_3pi4 = gtv.get_tangential_vel(
    array_run_3_angle_3pi4, theta_vec[2])

# Evaluate and return tangential velocity components for simulation 4

u_theta_run_4_angle_pi4 = gtv.get_tangential_vel(
    array_run_4_angle_pi4, theta_vec[0])
u_theta_run_4_angle_pi2 = gtv.get_tangential_vel(
    array_run_4_angle_pi2, theta_vec[1])
u_theta_run_4_angle_3pi4 = gtv.get_tangential_vel(
    array_run_4_angle_3pi4, theta_vec[2])
...
e_rr_sim_1_theta_pi4, e_rtheta_sim_1_pi4 = grst.get_rate_strain_tensor(
    u_r_run_1_angle_pi4, u_theta_run_1_angle_pi4, s_run_1_angle_pi4)
e_rr_sim_1_theta_pi2, e_rtheta_sim_1_pi2 = grst.get_rate_strain_tensor(
    u_r_run_1_angle_pi2, u_theta_run_1_angle_pi2, s_run_1_angle_pi2)
e_rr_sim_1_theta_3pi4, e_rtheta_sim_1_3pi4 = grst.get_rate_strain_tensor(
    u_r_run_1_angle_3pi4, u_theta_run_1_angle_3pi4, s_run_1_angle_3pi4)

# Simulation 2:

e_rr_sim_2_theta_pi4, e_rtheta_sim_2_pi4 = grst.get_rate_strain_tensor(
    u_r_run_2_angle_pi4, u_theta_run_2_angle_pi4, s_run_2_angle_pi4)
e_rr_sim_2_theta_pi2,  e_rtheta_sim_2_pi2 = grst.get_rate_strain_tensor(
    u_r_run_2_angle_pi2, u_theta_run_2_angle_pi2, s_run_2_angle_pi2)
e_rr_sim_2_theta_3pi4,  e_rtheta_sim_2_3pi4 = grst.get_rate_strain_tensor(
    u_r_run_2_angle_3pi4, u_theta_run_2_angle_3pi4, s_run_2_angle_3pi4)

# Simulation 3:

e_rr_sim_3_theta_pi4,  e_rtheta_sim_3_pi4 = grst.get_rate_strain_tensor(
    u_r_run_3_angle_pi4, u_theta_run_3_angle_pi4, s_run_3_angle_pi4)
e_rr_sim_3_theta_pi2,  e_rtheta_sim_3_pi2 = grst.get_rate_strain_tensor(
    u_r_run_3_angle_pi2, u_theta_run_3_angle_pi2, s_run_3_angle_pi2)
e_rr_sim_3_theta_3pi4,  e_rtheta_sim_3_3pi4 = grst.get_rate_strain_tensor(
    u_r_run_3_angle_3pi4, u_theta_run_3_angle_3pi4, s_run_3_angle_3pi4)

# Simulation 4:

e_rr_sim_4_theta_pi4,  e_rtheta_sim_4_pi4 = grst.get_rate_strain_tensor(
    u_r_run_4_angle_pi4, u_theta_run_4_angle_pi4, s_run_4_angle_pi4)
e_rr_sim_4_theta_pi2,  e_rtheta_sim_4_pi2 = grst.get_rate_strain_tensor(
    u_r_run_4_angle_pi2, u_theta_run_4_angle_pi2, s_run_4_angle_pi2)
e_rr_sim_4_theta_3pi4,  e_rtheta_sim_4_3pi4 = grst.get_rate_strain_tensor(
    u_r_run_4_angle_3pi4, u_theta_run_4_angle_3pi4, s_run_4_angle_3pi4)
...
delta_1 = s_run_1_angle_pi4[1]
delta_2 = s_run_1_angle_pi4[2]
size_meas_1 = 1 / np.sqrt(delta_1 * delta_2)

delta_1 = s_run_2_angle_pi4[1]
delta_2 = s_run_2_angle_pi4[2]
size_meas_2 = 1 / np.sqrt(delta_1 * delta_2)

delta_1 = s_run_3_angle_pi4[1]
delta_2 = s_run_3_angle_pi4[2]
size_meas_3 = 1 / np.sqrt(delta_1 * delta_2)

delta_1 = s_run_4_angle_pi4[1]
delta_2 = s_run_4_angle_pi4[2]
size_meas_4 = 1 / np.sqrt(delta_1 * delta_2)

size_meas_pi4 = [size_meas_1, size_meas_2, size_meas_3, size_meas_4]
e_rr_pi4 = [e_rr_sim_1_theta_pi4, e_rr_sim_2_theta_pi4,
            e_rr_sim_3_theta_pi4, e_rr_sim_4_theta_pi4]
e_rtheta_pi4 = [e_rtheta_sim_1_pi4, e_rtheta_sim_2_pi4,
                e_rtheta_sim_3_pi4, e_rtheta_sim_4_pi4]
...
plt.title("Rate of Strain Tensor vs Linear Size of Mesh Measurement at theta = pi/4", wrap=True)
...
delta_1 = s_run_1_angle_pi2[1]
delta_2 = s_run_1_angle_pi2[2]
size_meas_1 = 1 / np.sqrt(delta_1 * delta_2)

delta_1 = s_run_2_angle_pi2[1]
delta_2 = s_run_2_angle_pi2[2]
size_meas_2 = 1 / np.sqrt(delta_1 * delta_2)

delta_1 = s_run_3_angle_pi2[1]
delta_2 = s_run_3_angle_pi2[2]
size_meas_3 = 1 / np.sqrt(delta_1 * delta_2)

delta_1 = s_run_4_angle_pi2[1]
delta_2 = s_run_4_angle_pi2[2]
size_meas_4 = 1 / np.sqrt(delta_1 * delta_2)

size_meas_pi2 = [size_meas_1, size_meas_2, size_meas_3, size_meas_4]
e_rr_pi2 = [e_rr_sim_1_theta_pi2, e_rr_sim_2_theta_pi2,
            e_rr_sim_3_theta_pi2, e_rr_sim_4_theta_pi2]
e_rtheta_pi2 = [e_rtheta_sim_1_pi2, e_rtheta_sim_2_pi2,
                e_rtheta_sim_3_pi2, e_rtheta_sim_4_pi2]

plt.plot(size_meas_pi2, e_rr_pi2, linestyle='-')
plt.plot(size_meas_pi2, e_rtheta_pi2, linestyle='-')
plt.xlabel("Linear Size of Mesh Measurement (1/delta)")
plt.ylabel("Rate of Strain Tensor")
plt.title("Rate of Strain Tensor vs Linear Size of Mesh Measurement at theta = pi/2", wrap=True)
plt.legend(['e_rr', 'e_rtheta'])
...
delta_1 = s_run_1_angle_3pi4[1]
delta_2 = s_run_1_angle_3pi4[2]
size_meas_1 = 1 / np.sqrt(delta_1 * delta_2)

delta_1 = s_run_2_angle_3pi4[1]
delta_2 = s_run_2_angle_3pi4[2]
size_meas_2 = 1 / np.sqrt(delta_1 * delta_2)

delta_1 = s_run_3_angle_3pi4[1]
delta_2 = s_run_3_angle_3pi4[2]
size_meas_3 = 1 / np.sqrt(delta_1 * delta_2)

delta_1 = s_run_4_angle_3pi4[1]
delta_2 = s_run_4_angle_3pi4[2]
size_meas_4 = 1 / np.sqrt(delta_1 * delta_2)

size_meas_3pi4 = [size_meas_1, size_meas_2, size_meas_3, size_meas_4]
e_rr_3pi4 = [e_rr_sim_1_theta_3pi4, e_rr_sim_2_theta_3pi4,
             e_rr_sim_3_theta_3pi4, e_rr_sim_4_theta_3pi4]
e_rtheta_3pi4 = [e_rtheta_sim_1_3pi4, e_rtheta_sim_2_3pi4,
                 e_rtheta_sim_3_3pi4, e_rtheta_sim_4_3pi4]

plt.plot(size_meas_3pi4, e_rr_3pi4, linestyle='-')
plt.plot(size_meas_3pi4, e_rtheta_3pi4, linestyle='-')
plt.xlabel("Linear Size of Mesh Measurement (1/delta)")
plt.ylabel("Rate of Strain Tensor")
plt.title("Rate of Strain Tensor vs Linear Size of Mesh Measurement at theta = 3pi/4", wrap=True)
plt.legend(['e_rr', 'e_rtheta'])
